...
public class ReadPasswordAgent extends AgentJid {
    ...
    public void start(RP<Jid> rp) throws Exception {
        ...
        consoleIO.print(getValueJid().getValue());
        StringJid result = (StringJid) JAFactory.
                newActor(this, JidFactories.STRING_JID_TYPE, getMailbox());
        String s = consoleIO.readPassword();
        if (s != null)
            result.setValue(s);
